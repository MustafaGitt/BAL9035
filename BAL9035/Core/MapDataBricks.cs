...
{
    public class MapDataBricks
    {

        public Form9035 MapBricksResult(DataTable dt)
        {
            try
            {
                ...
                foreach (DataRow dataRow in dt.Rows)
                {
                    ...
                    string[] caseSubTypeArray = dataRow["CaseSubType"].ToString().Split(',');
                    if (caseSubTypeArray[1].ToString()=="H-1B" || caseSubTypeArray[1].ToString()=="E-3" || caseSubTypeArray[1].ToString()=="H-1B1")
                    {
                        form9035.SectionA.A1 = caseSubTypeArray[1].ToString();
                        if (!string.IsNullOrEmpty(caseSubTypeArray[1].ToString()) && caseSubTypeArray[1].ToString() == "H-1B1")
                        {
        ...
        // Map Lists Objects
        public Lists CreateBricksLists(DataTable dt, string balno)
        {
            try
            {
                string AddressLine1 = "";
        ...
        private string citizenshipValue(DataRow dataRow)
        {
            ...
            string returnValue = "";
            if (dataRow["Citizenship 1"].ToString().ToLower() == "chile" || dataRow["Citizenship 2"].ToString().ToLower() == "chile" || dataRow["Citizenship 3"].ToString().ToLower() == "chile")
            {
                isChileExist = true;
            }
            if(dataRow["Citizenship 1"].ToString().ToLower() == "singapore" || dataRow["Citizenship 2"].ToString().ToLower() == "singapore" || dataRow["Citizenship 3"].ToString().ToLower() == "singapore")
            {

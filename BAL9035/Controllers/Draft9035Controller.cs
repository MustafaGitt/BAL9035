        ...
        public ActionResult Index([FromBody] OIDCRequest request)
        {
            ...
            try
            {
                ...
                if (url.Contains("localhost"))
                {
                    ...
                    //localhost
                    request.State = "'+bal_no=1615.70361.3;id_no=BOT0016027;-5791a545d45a92763d8216ffb7004e3ebc32226af366113cf24975ea00014d51+";
                    request.Code = "182635";
                }
                TempData["Error"] = "";
...
where CC.BALNumber ='" + bal_no + "' and ca.IsActive = 1 order by cc.BALNumber";

        ...
        public ActionResult Index([FromBody] OIDCRequest request)
        {
            ...
            try
            {
                ...
                if (url.Contains("localhost"))
                {
                    ...
                    //localhost
                    request.State = "'+bal_no=20000.50054.51;id_no=BOT0001711;-5791a545d45a92763d8216ffb7004e3ebc32226af366113cf24975ea00014d51+";
                    request.Code = "182635";
                }
                TempData["Error"] = "";
                string filter = "";
            ...
            catch (Exception ex)
            {
                ...
                if (isSqlException)
                {
                    api.AddErrorQueueItem(ViewBag.id_no, "The process cannot proceed due to SQL connection issue.Please submit again later", "Business", "The process cannot proceed due to SQL connection issue.Please submit again later", "Failed", bal_no);
                }
                else
                {
